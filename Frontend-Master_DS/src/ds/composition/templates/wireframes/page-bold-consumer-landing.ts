...
export const PAGE_BOLD_CONSUMER_LANDING_META: WireframeMeta = {
  id: "page-bold-consumer-landing",
  archetype: "bold-consumer",
  purpose: "landing",
  shell: "public",
  label: "Page — Bold Consumer Landing",
  description: "Hero oversized → logos auto-fit → bold 3-col features → bold stats band → bold 3-col testimonials → bold pricing → bold accordion FAQ → full-bleed CTA.",
  density: "comfortable",
  complexity: "standard",
  isDefault: true,
  sections: [
      { kind: "hero", variantId: "hero-bold-consumer-oversized" },
      { kind: "logo-cloud", variantId: "logo-cloud-bold-consumer-1" },
      { kind: "features", variantId: "features-bold-consumer-1" },
      { kind: "stats-band", variantId: "stats-band-bold-consumer-1" },
      { kind: "testimonials", variantId: "testimonials-bold-consumer-2" },
      { kind: "pricing", variantId: "pricing-bold-consumer-1" },
      { kind: "faq", variantId: "faq-bold-consumer-1" },
      { kind: "cta", variantId: "cta-full-bleed" },
  ],
};

/** Demo content factory. Returns a complete PublicPageModel for preview/smoke. */
export function getPageBoldConsumerLandingDemoPage(): PublicPageModel {
  return {
    id: "demo-page-bold-consumer-landing",
    title: "Page — Bold Consumer Landing",
    archetype: "bold-consumer",
    sections: [
      {
        id: "hero",
        kind: "hero",
        variant: "hero-bold-consumer-oversized",
        kicker: "New",
      ...
      },
      {
        id: "logos",
        kind: "logo-cloud",
        variant: "logo-cloud-bold-consumer-1",
      ...
      },
      {
        id: "features",
        kind: "features",
        variant: "features-bold-consumer-1",
      ...
      },
      {
        id: "stats",
        kind: "stats-band",
        variant: "stats-band-bold-consumer-1",
      ...
      },
      {
        id: "testimonials",
        kind: "testimonials",
        variant: "testimonials-bold-consumer-2",
