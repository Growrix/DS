...
export const PAGE_PORTFOLIO_CRAFT_LANDING_META: WireframeMeta = {
  id: "page-portfolio-craft-landing",
  archetype: "portfolio-craft",
  purpose: "landing",
  shell: "public",
  label: "Page — Portfolio Craft Landing",
  description: "Hero full-bleed showcase → portfolio capabilities → 2-col case studies grid → portfolio large quote → 2-col studio team → portfolio channel cards → portfolio minimal footer.",
  density: "comfortable",
  complexity: "standard",
  isDefault: true,
  sections: [
      { kind: "hero", variantId: "hero-portfolio-craft-2" },
      { kind: "features", variantId: "features-portfolio-craft-1" },
      { kind: "case-studies", variantId: "case-studies-portfolio-craft-2" },
      { kind: "testimonials", variantId: "testimonials-portfolio-craft-1" },
      { kind: "team", variantId: "team-portfolio-craft-1" },
...
export function getPagePortfolioCraftLandingDemoPage(): PublicPageModel {
  return {
    id: "demo-page-portfolio-craft-landing",
    title: "Page — Portfolio Craft Landing",
    archetype: "portfolio-craft",
    sections: [
      {
        id: "hero",
        kind: "hero",
        variant: "hero-portfolio-craft-2",
        kicker: "New",
      ...
      },
      {
        id: "cases",
        kind: "case-studies",
        variant: "case-studies-portfolio-craft-2",
      ...
      },
      {
        id: "team",
        kind: "team",
        variant: "team-portfolio-craft-1",
